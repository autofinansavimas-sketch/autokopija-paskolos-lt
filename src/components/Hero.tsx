        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid lg:grid-cols-[60%_40%] gap-12 items-center max-w-7xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <h1 id="hero-heading" className="text-4xl md:text-6xl lg:text-7xl font-black leading-tight uppercase animate-slide-up tracking-tight">
                AUTOPASKOLOS.LT - <span className="gradient-text">PASKOLOS NE TIK AUTOMOBILIUI</span>
              </h1>
              
              <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-foreground uppercase animate-slide-up relative overflow-hidden" style={{ animationDelay: '0.1s' }}>
                <span className="inline-block animate-pulse-slow">
                  GAUK GERIAUSIĄ PASKOLOS PASIŪLYMĄ <span className="gradient-text animate-shimmer bg-[length:200%_100%]">VOS PER 30 MINUČIŲ</span>
                </span>
              </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-8 border-t border-border/50 animate-slide-up" style={{ animationDelay: '0.4s' }}>
                <div className="text-center group p-4 rounded-xl hover:bg-primary/5 transition-all duration-300 cursor-default">
                ...
                <div className="text-center group p-4 rounded-xl hover:bg-primary/5 transition-all duration-300 cursor-default">
                  <div className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent transition-transform group-hover:scale-110 duration-300">
                    <span className="inline-flex items-baseline">
                      10<span className="text-2xl md:text-3xl ml-1">min</span>
                    </span>
                  </div>
                  <div className="text-base text-muted-foreground mt-2 uppercase font-medium">SPRENDIMAS</div>
                </div>
                <div className="text-center group p-4 rounded-xl hover:bg-primary/5 transition-all duration-300 cursor-default">
                  <div className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-emerald-500 to-teal-500 bg-clip-text text-transparent transition-transform group-hover:scale-110 duration-300">0€</div>
