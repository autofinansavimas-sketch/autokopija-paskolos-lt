    ...
    <section className="py-12 bg-secondary/10 overflow-hidden" aria-labelledby="partners-heading">
      ...
      <div className="relative">
        ...
        <div className="flex overflow-hidden">
          <div className="flex animate-scroll gap-6 py-4 items-center">
            {duplicatedPartners.map((partner, index) => (
              <div
                key={index}
                className="flex items-center justify-center px-6 bg-card rounded-xl border border-border/50 hover:border-primary/30 hover:shadow-lg transition-all duration-300 w-[160px] h-[80px] flex-shrink-0"
              >
                <img 
                  src={partner.logo} 
                  alt={partner.name}
